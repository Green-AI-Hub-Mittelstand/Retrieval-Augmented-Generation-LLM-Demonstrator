...
from models import session, Mitteilung,Projekt
        ...
        # Pop a URL from the stack
            ...
            if url not in self.visited:
                ...
                if content.status_code == 200:
                    ...
                    if url.startswith('https://www.green-ai-hub.de/pilotprojekte/pilotprojekt'):
                        try:
                            ...
                            content_text = ""
                            for c in content:
                                if not c.find_parent('noscript'):
                                    content_text += c.get_text()

                            projekt = Projekt(title=text.title.string, content = content_text)
                            session.add(projekt)
                            session.commit() 
                            ...
                            #pass
                    if url.startswith('https://www.green-ai-hub.de/pilotprojekte'):
                        ...
                        for l in soup.find_all("a"):
                            ...
                            if href:
                                ...
                                if absolute_link.startswith('https://www.green-ai-hub.de/pilotprojekte'):
                                    self.stack.append(absolute_link)

print("start")        
crawler = Crawl('https://www.green-ai-hub.de/pilotprojekte')
crawler.crawl()
